...
export default function ProviderCard({ provider }: ProviderCardProps) {
  ...
  const formattedRating = provider.rating ? provider.rating.toFixed(1) : "0.0";
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 hover:shadow-lg transition-all hover:border-primary cursor-pointer">
        ...
        <div className="p-6">
          ...
          <div className="mt-6 flex justify-between items-center">
            ...
            <span className="inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md text-white bg-secondary-500 hover:bg-secondary-600">
              View Profile
            </span>
          </div>
        </div>
